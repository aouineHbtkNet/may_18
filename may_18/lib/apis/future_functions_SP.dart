...
//==============================================addUserAddressToSPB 4/2/2022  used ok   =============================
  ...
  addUserMobilePhoneToSPB(String value) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString('userMobilePhone', value);
  }
  addUserFixedPhoneToSPB(String value) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString('userFixedName', value);
  }

  addUserNoDeIdToSPB(String value) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString('useridentificationNumber', value);
  }
