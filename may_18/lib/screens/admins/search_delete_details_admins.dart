...
class SearchDetailsDeleteAdminScrn extends StatefulWidget {
  const SearchDetailsDeleteAdminScrn({Key? key}) : super(key: key);
  static const String id = '/SearchDetailsDeleteAdminScrn';
  @override
  State<SearchDetailsDeleteAdminScrn> createState() => _SearchDetailsDeleteAdminScrnState();
}
...
class _SearchDetailsDeleteAdminScrnState extends State<SearchDetailsDeleteAdminScrn> {
